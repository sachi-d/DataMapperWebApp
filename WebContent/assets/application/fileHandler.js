(function () {
    ...
    function setDivElement(nodeName) {
        return "<div class=\"leaf\">" + nodeName + "</div>";
    }

    function setInLeaf(nodeName) {
        return "<div class=\"leaf in-leaf glyphicon glyphicon-play\">" + nodeName + "</div>";
    }

    function setOutLeaf(nodeName) {
        return "<div class=\"leaf out-leaf glyphicon glyphicon-play\"> " + nodeName + "</div>";
    }
    ...
    if (window.File && window.FileList && window.FileReader) {
        init("input-file-select", "input-file-drag", "input-structure");
        init("output-file-select", "output-file-drag", "output-structure");
    }
